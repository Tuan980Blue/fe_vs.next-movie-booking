    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 opacity-5">
                <div
                    className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-primary-pink to-accent-orange opacity-10"></div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-neutral-white opacity-75 text-sm">123 Đường TA, Quận Cam,
                                                TP.HCM</p>
                                        </div>
                                    </div>
                                </div>
            ...
            >
                <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                        ...
                        {/* Additional Info */}
                        <div
                            className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-center md:text-right">
