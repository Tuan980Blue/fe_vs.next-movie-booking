    ...
    return (
        <nav className="relative shadow-lg">
            ...
            <div className="absolute inset-0 opacity-10">
                <div
                    className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-primary-pink to-accent-orange opacity-20"></div>
                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <div className="relative">
                            ...
                            />
                            <button
                                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-primary-pink hover:text-cinema-neonPink transition-colors">
